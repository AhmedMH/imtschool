...
">
    ...
    <div id="tf-home" class="text-center">
        <div class="overlay">
            <div class="content">
                <h1 id="fall" class="wow animated " style="visibility: hidden; color:#FFF;">Welcome to <strong class="color">Imtschool</strong></h1>
                <br>   
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 wow bounceInLeft animated">
                    <img  style="" src="/img/02.jpg" class="img-responsive">
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                    <div class="section-title center">
                        ...
                        <div class="clearfix"></div>
                        <small><em>We are here to help, you are more than welcome to come visit us or Ask anything away!</em></small>
                    </div>
                    </div>
                     <div class="row">
